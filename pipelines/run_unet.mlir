module @sdxl_compiled_pipeline {
  ...
  func.func @forward(%sample: tensor<1x4x128x128xf16>, %p_embeds: tensor<2x64x2048xf16>, %t_embeds: tensor<2x1280xf16>, %time_ids: tensor<2x6xf16>, %guidance_scale: tensor<1xf16>, %this_step: tensor<1xi64>) -> tensor<1x4x128x128xf16> {
