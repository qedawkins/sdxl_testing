module @sdxl_compiled_pipeline {
  func.func private @compiled_scheduled_unet.run_initialize(%arg0: tensor<1x4x128x128xf16>) -> (tensor<1x4x128x128xf16>, tensor<2x6xf16>, tensor<i64>) attributes { iree.abi.model = "coarse-fences" }
  ...
  func.func @produce_image_latents(%sample: tensor<1x4x128x128xf16>, %p_embeds: tensor<2x64x2048xf16>, %t_embeds: tensor<2x1280xf16>, %arg_ids: tensor<2x6xf16>, %guidance_scale: tensor<1xf16>, %steps_int_arg: i64, %steps_arg: tensor<i64>) -> tensor<1x4x128x128xf16> {
