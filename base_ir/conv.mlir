module {
  func.func @forward(%lhs: tensor<2x34x34x1280xf16>, %rhs: tensor<3x3x1280x1280xf16>) -> tensor<2x32x32x1280xf32> {
    ...
    %13 = linalg.conv_2d_nhwc_hwcf { dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64> }
      ins(%lhs, %rhs : tensor<2x34x34x1280xf16>, tensor<3x3x1280x1280xf16>)
